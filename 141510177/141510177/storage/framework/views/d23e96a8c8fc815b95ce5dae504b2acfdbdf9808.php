                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/lemburp')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('kode_lembur_id') ? ' has-error' : ''); ?>">
                            <label for="kode_lembur_id" class="col-md-4 control-label">Kode Kategori Lembur</label>
                            ...
                            <div class="col-md-6">
                                <select name="kode_lembur_id" class="form-control">
                                    ...
                                    <option value="<?php echo e($data->id); ?>"><?php echo e($data->kode_l); ?></option>
                                ...
                                <center><label><font color="red"> Tidak Cocok dengan kategori lembur </font></label></center><br>
